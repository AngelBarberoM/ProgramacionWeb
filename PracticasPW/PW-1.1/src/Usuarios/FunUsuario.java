...
public class FunUsuario{
	...
	public boolean comprobarPassword(String Correo, String Contrasena){
		...
		for(Persona i : vector){
			...
			if(i.getCorreo().equals(Correo)){
				...
				if(i.getContraseña().equals(Contrasena)) {
	...
	public void BorrarUsuario(String Correo){
		...
		for(Persona i : v2) {
			...
			i.RegistrarUsuarioFich(i.getNombre(), i.getApellidos(), i.getNombreUsuario(), i.getCorreo(), i.getContraseña());
		}
	}
	...
	public void ActualizarUsuario(String Correo){
    	...
    	contrasena = Persona1.getContraseña(); 
    	...
    	Persona1.setContraseña(contrasena);
		
    	this.BorrarUsuario(Correo);
		
		if(correo.equals(Correo)){
			
			this.RegistrarUsuarioFichMismoCorreo(Persona1.getNombre(), Persona1.getApellidos(), Persona1.getNombreUsuario(), Persona1.getCorreo(), Persona1.getContraseña());
		}	
		else{
