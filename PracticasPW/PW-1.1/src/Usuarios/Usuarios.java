...
public class Usuarios {
	...
	public void DarAltaUsuario(Persona Persona1){
		...
		if(Instancia!=null){
			...
			this.Usuario.RegistrarUsuarioFichMismoCorreo(Persona1.getNombre(), Persona1.getApellidos(), Persona1.getNombreUsuario(), Persona1.getCorreo(), Persona1.getContraseña());
		}
	}
