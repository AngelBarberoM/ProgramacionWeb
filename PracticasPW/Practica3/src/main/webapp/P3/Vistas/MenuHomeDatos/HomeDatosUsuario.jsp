...
<%@ page import="JavaBeans.CustomerBean"%>
...
<h2>Sus Datos son:</h2>
	...
	<hr class="c">
	<a class="static">Fecha de registro:  NULL</a>
	<a class="static">Fecha de ultima conexión:  </a><a class="var"><%= customerBean.getLoggedString()%></a>
	<hr class="a">
</div>
