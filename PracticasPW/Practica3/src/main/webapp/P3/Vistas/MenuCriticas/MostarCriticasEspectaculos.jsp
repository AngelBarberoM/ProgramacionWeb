...
<meta charset="UTF-8">
<jsp:useBean  id="allCritBean" scope="session" class="JavaBeans.TodasCriticasJavaBean"></jsp:useBean>
<jsp:useBean  id="customerBean" scope="session" class="JavaBeans.CustomerBean"></jsp:useBean>
<%@ page import="GeneralDTO.CriticaDTO"%>
<%@ page import="GeneralDTO.VotanteDTO"%>
...
%>
	...
	<%
	if(punt.getCorreo().equals(customerBean.getEmailUser()))
	{
	%>
	<div class="side2">
		<a>Likes</a>
		...
		<form method="Post" action="../../../EliminarCriticaServlet">
		    <button type="submit" value="Borrar Crítica" class="delete">Borrar Critica</button>
	...
	{
		int flag = 0;
		for(VotanteDTO vot : punt.getVotantes())
		{
			if(vot.getPersonaVota().equals(customerBean.getEmailUser()) && vot.getVotoPersona().equals("like"))
            {			
				flag = 1;	
             %>	
             	<div class="side">
            ...
            else if(vot.getPersonaVota().equals(customerBean.getEmailUser()) && vot.getVotoPersona().equals("dislike"))
            {
            	flag = 1;
			%>
				<div class="side">
