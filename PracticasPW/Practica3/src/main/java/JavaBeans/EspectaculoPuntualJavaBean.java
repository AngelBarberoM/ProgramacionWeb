...
public class EspectaculoPuntualJavaBean implements java.io.Serializable{
...
private static final long serialVersionUID = 5259493186386143210L;
	...
	private ArrayList<EspectaculoPuntualDTO> espsPunt;
	...
	public ArrayList<EspectaculoPuntualDTO> getEspectaculosPunt()
	{
	...
	public void setEspectaculosPunt(ArrayList<EspectaculoPuntualDTO> esps)
	{
		this.espsPunt = esps;
	}
}
