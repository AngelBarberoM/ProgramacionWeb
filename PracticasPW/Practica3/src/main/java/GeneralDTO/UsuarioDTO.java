...
public class UsuarioDTO {
	...
	//VARIABLES
		...
		public UsuarioDTO(String Nombre, String Correo, String NombreUsuario, String Contrasena, String TipoUsuario, LocalDateTime HoraRegistro){
		...
		public String getRegistroToString()
		{
			DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
			String stringRegister = this.HoraRegistro.format(formatter);
			return stringRegister;
		}
		
		public String getConexionToString()
		{
			DateTimeFormatter formatter = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
			String stringLogged = this.UltimaConex.format(formatter);
			return stringLogged;
		}
		//MODIFICADORES
