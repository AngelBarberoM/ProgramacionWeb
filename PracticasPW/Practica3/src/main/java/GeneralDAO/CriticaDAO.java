...
public class CriticaDAO {
	...
	private DBConexion DBConex;
	private Connection conexion;
	
	public CriticaDAO( String url, String usuario, String contrasena){
		
		this.url = url;
		this.usuario = usuario;
		this.contrasena = contrasena;
		this.DBConex = new DBConexion(this.url, this.usuario, this.contrasena);
		this.conexion = DBConex.getConnection();
	}
	
	public void desCriticaDAO(){
		this.DBConex.closeConnection();
	}
